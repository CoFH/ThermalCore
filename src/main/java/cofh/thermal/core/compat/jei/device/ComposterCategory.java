...
public class ComposterCategory implements IRecipeCategory<ComposterCategory.ComposterMapping> {
    ...
    protected final RecipeType<ComposterMapping> type;
    ...
    public ComposterCategory(IGuiHelper guiHelper, ItemStack icon, RecipeType<ComposterMapping> type) {
    ...
    @Override
    public RecipeType<ComposterMapping> getRecipeType() {
