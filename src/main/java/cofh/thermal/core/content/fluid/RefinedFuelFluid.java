package cofh.thermal.core.content.fluid;
...
public class RefinedFuelFluid extends FluidCoFH {
    ...
    protected RefinedFuelFluid() {
        ...
        bucket = ITEMS.register(bucket(ID_FLUID_REFINED_FUEL), () -> new BucketItem(stillFluid, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).tab(ThermalItemGroups.THERMAL_ITEMS)));
    }
