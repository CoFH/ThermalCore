...
import static cofh.thermal.lib.init.ThermalIDs.ID_FLUID_SAP;
...
public class SapFluid extends FluidCoFH {
    ...
    protected SapFluid() {
        ...
        bucket = ITEMS.register(bucket(ID_FLUID_SAP), () -> new BucketItem(stillFluid, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    }
