...
import static cofh.thermal.lib.init.ThermalIDs.ID_FLUID_REFINED_FUEL;
...
public class RefinedFuelFluid extends FluidCoFH {
    ...
    protected RefinedFuelFluid() {
        ...
        bucket = ITEMS.register(bucket(ID_FLUID_REFINED_FUEL), () -> new BucketItem(stillFluid, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    }
