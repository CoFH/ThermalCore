...
import static cofh.thermal.lib.init.ThermalIDs.ID_FLUID_RESIN;
...
public class ResinFluid extends FluidCoFH {
    ...
    protected ResinFluid() {
        ...
        bucket = ITEMS.register(bucket(ID_FLUID_RESIN), () -> new BucketItem(stillFluid, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    }
