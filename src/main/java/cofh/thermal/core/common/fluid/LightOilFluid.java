...
import static cofh.thermal.lib.init.ThermalIDs.ID_FLUID_LIGHT_OIL;
...
public class LightOilFluid extends FluidCoFH {
    ...
    protected LightOilFluid() {
        ...
        bucket = ITEMS.register(bucket(ID_FLUID_LIGHT_OIL), () -> new BucketItem(stillFluid, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    }
