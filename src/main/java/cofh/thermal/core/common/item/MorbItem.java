...
//import cofh.thermal.core.common.entity.projectile.ThrownMorb;
...
//
//public class MorbItem extends FluidContainerItem {
//
//    protected static int cooldown = 0;
//
//    public MorbItem(Properties builder, int fluidCapacity, Predicate<FluidStack> validator) {
//
...
//            createMorb(stack, worldIn, playerIn);
//        }
...
//    }
//
//    protected void createMorb(ItemStack stack, Level world, Player player) {
//
//        ThrownMorb morb = new ThrownMorb(world, player);
//        ItemStack throwStack = cloneStack(stack, 1);
//        throwStack.setDamageValue(1);
//        morb.setItem(throwStack);
//        morb.shootFromRotation(player, player.getXRot(), player.getYRot(), 0.0F, 1.5F, 0.5F);
//        world.addFreshEntity(morb);
//    }
//
...
//
//            ThrownMorb morb = new ThrownMorb(worldIn, position.x(), position.y(), position.z());
