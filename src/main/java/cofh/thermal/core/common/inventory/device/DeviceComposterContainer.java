...
import static cofh.thermal.core.init.registries.TCoreContainers.DEVICE_COMPOSTER_CONTAINER;

public class DeviceComposterContainer extends TileCoFHContainer {
