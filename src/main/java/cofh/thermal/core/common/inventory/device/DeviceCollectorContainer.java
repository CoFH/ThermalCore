...
import static cofh.thermal.core.init.registries.TCoreContainers.DEVICE_COLLECTOR_CONTAINER;

public class DeviceCollectorContainer extends TileCoFHContainer {
