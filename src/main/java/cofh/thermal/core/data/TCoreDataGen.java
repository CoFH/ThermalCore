...
//
//        TCoreTagsProvider.Block blockTags = new TCoreTagsProvider.Block(pOutput, event.getLookupProvider(), exFileHelper);
//
//        gen.addProvider(event.includeServer(), blockTags);
//        gen.addProvider(event.includeServer(), new TCoreTagsProvider.Item(pOutput, event.getLookupProvider(), blockTags.contentsGetter(), exFileHelper));
