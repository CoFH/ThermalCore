...
//
//        Advancement root = Advancement.Builder.advancement().display(BLOCKS.get(ID_TINKER_BENCH), Component.translatable("advancements.thermal.root.title"), Component.translatable("advancements.thermal.root.description"), new ResourceLocation("thermal:textures/gui/advancements/backgrounds/blueprint.png"), FrameType.TASK, false, false, false).addCriterion("has_tinker_bench", InventoryChangeTrigger.TriggerInstance.hasItems(BLOCKS.get(ID_TINKER_BENCH))).save(advancementConsumer, "thermal:root");
