...
public class TCoreTileEntities {
    ...
    public static final RegistryObject<BlockEntityType<?>> DEVICE_XP_CONDENSER_TILE = TILE_ENTITIES.register(ID_DEVICE_XP_CONDENSER, () -> BlockEntityType.Builder.of(DeviceXpCondenserTile::new, BLOCKS.get(ID_DEVICE_XP_CONDENSER)).build(null));
