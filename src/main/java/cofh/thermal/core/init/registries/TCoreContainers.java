...
public class TCoreContainers {
    ...
    public static final RegistryObject<MenuType<DeviceXpCondenserContainer>> DEVICE_XP_CONDENSER_CONTAINER = CONTAINERS.register(ID_DEVICE_XP_CONDENSER, () -> IForgeMenuType.create((windowId, inv, data) -> new DeviceXpCondenserContainer(windowId, getClientWorld(), data.readBlockPos(), inv, getClientPlayer())));
